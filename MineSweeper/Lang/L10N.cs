...
namespace MineSweeper.Lang
{
    public static class L10N
    {
        ...
        private static string lastAreaCode = string.Empty;

        public static void SetUIText(Form form, string areaCode)
        {
